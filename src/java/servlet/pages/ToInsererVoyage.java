 ...
 * @author PC
 */
public class ToInsererVoyage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ToInsererVoyage</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ToInsererVoyage at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
            ...
            try{
                ...
                connection.close();
                RequestDispatcher dispatcher = request.getRequestDispatcher("pages/inserer/insererVoyage.jsp");
